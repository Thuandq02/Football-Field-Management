...
Route::prefix('/admin')->group(function () {
    ...
    Route::get('/login', [AccountController::class, 'showLogin'])->name('login.index');
    Route::post('/login', [AccountController::class, 'login'])->name('login');
    Route::get('/logout', [AccountController::class, 'logOut'])->name('logout');
    Route::get('/register', [AccountController::class, 'showRegister'])->name('register.show');
    Route::post('/register', [AccountController::class, 'register'])->name('register.index');
